...
export const trendingCategories = [
  ...
  },
  {
    ...
    name: 'Home Services',
    count: 186,
    image: 'https://images.pexels.com/photos/6195085/pexels-photo-6195085.jpeg?auto=compress&cs=tinysrgb&w=800',
  },
  {
    id: 3,
...
export const testimonials = [
  {
    ...
    comment: 'Vendora helped me connect with local customers I never would have reached otherwise. My business has grown 30% since joining!',
  ...
  },
  {
    ...
    comment: 'I love being able to discover unique local businesses in my area. The map feature makes it so easy to find exactly what I need.',
  ...
  },
  {
    ...
    comment: 'As someone who moves frequently for work, Vendora is my go-to for finding trusted services in new neighborhoods.',
